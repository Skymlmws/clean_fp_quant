...
def load_condition_models(
    ...
    **kwargs,
    ...
    """Load tokenizer and text encoder for LTX prompts.
...
def load_latent_models(
    ...
    **kwargs,
    ...
    """Load the VAE for LTX video latents.
...
def load_diffusion_models(
    ...
    **kwargs,
    ...
    """Load transformer and scheduler for LTX diffusion.
...
def initialize_pipeline(
    ...
    **kwargs,
    ...
    """Initialize an LTXPipeline with optional component overrides.
    ...
    Returns:
        Initialized LTXPipeline instance.
    """
...
def prepare_conditions(
    ...
    **kwargs,
    ...
    Returns:
        Dict with prompt embeddings and attention mask.
    """
    ...
    return _encode_prompt_t5(
        tokenizer, text_encoder, prompt, device, dtype, max_sequence_length
    )
...
def prepare_latents(
    ...
    """Encode inputs into LTX latents and pack them for transformer use.
    ...
    Returns:
        Dict containing packed latents and metadata.
    """
    ...
    if not precompute:
        ...
        #  This is very stupid that we might possibly be storing the latents_mean and latents_std in every file
...
def post_latent_preparation(
    ...
    **kwargs,
    ...
    """Normalize and pack precomputed latents for training.

    Args:
        latents: Raw latent tensor.
        latents_mean: Latent mean tensor.
        latents_std: Latent std tensor.
    ...
    Returns:
        Dict with packed latents and metadata.
    """
...
def forward_pass(
    ...
    **kwargs,
    ...
    """Run the LTX transformer forward pass.
...
def validation(
    ...
    **kwargs,
    ...
    Args:
        ...
        frame_rate: Frame rate for output.
...
def _normalize_latents(
    ...
    """Normalize latents by mean/std statistics.
...
def _pack_latents(
    ...
    """Pack latents into patch tokens for transformer input.
