...
def get_config_from_model_name(model_name: str, training_type: str) -> Dict[str, Any]:
    """Return model config for a given model name and training type.

    Args:
        model_name: Model key (e.g., "wan", "cogvideox").
        training_type: Training type ("lora" or "full-finetune").

    Returns:
        Config dict for the requested model and training type.
    """
