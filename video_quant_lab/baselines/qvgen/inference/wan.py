...
RESOLUTION_MAP = {
    ...
    "wan2.1-t2v-14b-diffusers": (480, 832),
}
...
def generate_video(
    ...
    """Generate a video from text/image/video prompts and save to disk.
    ...
    if args.quant:
        ...
        quant_state_dict = safetensors.torch.load_file(
            os.path.join(args.quant_model_path, "diffusion_pytorch_model.safetensors")
        )
        random_list = []
        idx = 0
        lora = False
        ...
        pipe.transformer.load_state_dict(quant_state_dict, strict=False)
